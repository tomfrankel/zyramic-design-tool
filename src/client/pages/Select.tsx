  ...
  return (
    <>
      <div className="banner">
        PRELIMINARY draft. Palisade, Swing MBR, and Ceramic / SiC are separate product lines. Alper Özkan Sep 18 Arges/Ahmet Iraq quote is the polymer acceptance baseline. Not a complete-system designer and not a final customer/field issue.
      </div>
      <section className="hero">
        <div>
          ...
          <div className="grid-3" style={{ marginTop: "1rem" }}>
            ...
            <Link className="product-card" to="/proposal/ceramic-sic">
              <h3>Ceramic / SiC</h3>
              <p className="muted">Separate ceramic SiC line. Municipal WW MBR design flux 60 LMH. TDS dims and 44.8 kg dry. Pricing HELD / UNKNOWN. Not mixed with Palisade or Swing.</p>
            </Link>
          </div>
        </div>
        <div className="card">
